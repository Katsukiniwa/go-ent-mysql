...
func (_q *UserQuery) QueryHistories() *HistoryQuery {
...
func (_q *UserQuery) WithHistories(opts ...func(*HistoryQuery)) *UserQuery {
	query := (&HistoryClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadHistories(ctx context.Context, query *HistoryQuery, nodes []*User, init func(*User), assign func(*User, *History)) error {
